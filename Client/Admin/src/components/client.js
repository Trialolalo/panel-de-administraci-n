                ...
                <div class="tab-content active" data-tab="main">
                  <div class="form-row">
                      <div class="form-element">
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="surname" autocomplete="surname" data-onlyletters="true" />
                          </div>
                          <div class="form-element-label">
                              <label>
                                  Email
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="email" autocomplete="email" />
                          </div>
                          <div class="form-element-label">
                              <label>
                                  Teléfono
                          ...
                          <div class="form-element-input">
                              <input class="validate" name="phone" autocomplete="phone" />
                          </div>
                      </div>
                  </div>   
                  <div class="form-row">
...
customElements.define('client-component', Client)
